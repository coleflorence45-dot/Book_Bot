...
AUTHOR_WHITELIST = [
    ...
    "st george mivart",
    "frank buckland",
    # Victorian popular astronomy / science writers
    "robert ball", "sir robert ball",
    "agnes giberne",
    "richard proctor",       # Other Worlds Than Ours, Saturn and its System
    "john ellard gore",
...
PRIORITY_GENRE_ASTRONOMY = [
    ...
    # Common words in Victorian popular astronomy titles
    "starry", "starlit", "among the stars", "in starry",
    "the stars", "star land", "the heavens", "through the telescope",
    "the sky", "wonders of the sky", "wonders of astronomy",
    "cosmos", "nebula", "nebulae", "milky way",
]
...
PRIORITY_GENRE_NATURAL_HISTORY = [
    ...
    "insects", "insect", "wildlife",
    # Specific botanical phrases only — "botanical" alone is too broad
    # and matches modern gardening titles like "Gardening (Botanical) Book"
    "botanical illustration", "botanical illustrations",
    "botanical plates", "botanical survey",
    "botanical magazine", "botanical garden",
]
